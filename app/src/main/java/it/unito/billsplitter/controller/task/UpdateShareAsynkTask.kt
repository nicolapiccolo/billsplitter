...
class UpdateShareAsynkTask(context: Context): AsyncTask<Any, Int, Boolean>(){
    ...
    override fun doInBackground(vararg params: Any?): Boolean{
        ...
        if(split!=null && member!=null) return Model.instance.updatePercentages(split as ParseObject, member as ArrayList<SplitMember>)
        else return false
    }
}